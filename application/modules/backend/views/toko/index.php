					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								<label class="col-sm-3 col-form-label">PASAR</label>
								<div class="col-sm-9">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="input-group">
										<input type="text" name="search" onchange="get_items()" value="" id="search" class="form-control" placeholder="Nama Nama Toko">
...
<script type="text/javascript">
	...
	function get_items(page){
	    ...
	    $.post(site+'backend/toko/list_data', {
